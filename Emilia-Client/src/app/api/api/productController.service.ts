...
export class ProductControllerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getAllProductsByCategoryUsingGET(body?: ProductCategory, observe?: 'body', reportProgress?: boolean): Observable<Array<Product>>;
    public getAllProductsByCategoryUsingGET(body?: ProductCategory, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Product>>>;
    public getAllProductsByCategoryUsingGET(body?: ProductCategory, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Product>>>;
    public getAllProductsByCategoryUsingGET(body?: ProductCategory, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getOneUsingGET2(id: number, observe?: 'body', reportProgress?: boolean): Observable<Product>;
    public getOneUsingGET2(id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Product>>;
    public getOneUsingGET2(id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Product>>;
    public getOneUsingGET2(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getOneUsingGET2.');
        }
