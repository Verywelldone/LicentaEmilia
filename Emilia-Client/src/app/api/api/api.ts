...
export const APIS = [AuthControllerService, BasicErrorControllerService, OrderControllerService, ProductCategoryControllerService, ProductControllerService, TestControllerService];
