...
export class UserControllerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getAllUserFavoriteProductsUsingGET(observe?: 'body', reportProgress?: boolean): Observable<Array<ProductItem>>;
    public getAllUserFavoriteProductsUsingGET(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<ProductItem>>>;
    public getAllUserFavoriteProductsUsingGET(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<ProductItem>>>;
    public getAllUserFavoriteProductsUsingGET(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<ProductItem>>('get',`${this.basePath}/api/user/favorites/get-all`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
